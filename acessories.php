...
<head>
    ...
    <title>Sehad Store | Acessories</title>
</head>
...
<body>
    ...
    <div class="container" style="margin-top: 78.4px;" id="accessories">
        ...
        <br> <br>
        <ul id="container">
            <?php $ambil = $koneksi->query("SELECT * FROM produk WHERE id_kategori='2' AND stok_produk > '0'"); ?>
            <?php while ($perProduk = $ambil->fetch_assoc()) { ?>
                <li class="col-4">
                    ...
                    <p>Rp
                        <?= number_format($perProduk['harga_produk']); ?>
                    </p>
                    <span>
